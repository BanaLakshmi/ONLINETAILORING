...
public class UserController {
	...
	public ModelAndView helpRequestForAdmin(HttpSession session, ModelMap map) {
		...
		if (helpRequests.isEmpty()) {
			...
			map.addAttribute("helpRequests", helpRequests);
	...
	public ModelAndView saveResolution(@ModelAttribute("help") Help help, HttpSession session, ModelMap map)
			throws NullPointerException {

		// System.out.println("the request id
		// is..........................................."+requestId);
		// Help help1=(Help) session.getAttribute("help");
		ApplicationContext ctx = new ClassPathXmlApplicationContext("bean.xml");
		HelpDAO hdao = (HelpDAO) ctx.getBean("Hdao");
		
//Help help2=hdao.read(requestId);
		String resolution = help.getResolution();
		 help.setResolution(resolution);
			// Help help1=hdao.update(help);
