	...
	<div class="wrapper">
		...
		<form method="get" action="placeorder">
			...
			<div id="topwear" style="display: none;">
				...
				<div class="inputfield">
					<label>topLengths</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100"  name=topLengths
						id=topLengths class="input" />
				</div>
				<div class="inputfield">
					<label>neck</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100" name=neck id=neck class="input" />
				</div>
				<div class="inputfield">
					<label>top waist</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100" name=topwaist id=topwaist
						class="input" />
				</div>
				<div class="inputfield">
					<label>chest</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100" name=chest id=chest
						class="input" />
				</div>
				<div class="inputfield">
					<label>shoulderLength</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100" name=shoulderLength
			...
			<div id="bottomwear" style="display: none;">
				...
				<div class="inputfield">
					<label>bottomLengths</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100" name=bottomLengths
						id=bottomLengths class="input" />
				</div>
				<div class="inputfield">
					<label>hip</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100" name=hip id=hip class="input" />
				</div>
				<div class="inputfield">
					<label>kneeLength</label><input type="number" placeholder="1.0" step="0.01" min="0" max="100" name=kneeLength
